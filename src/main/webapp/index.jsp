...
<%--<head>--%>
  ...
  <%--<!-- Our Styles -->--%>
  <%--<link rel="stylesheet" type="text/css" href="app/modules/admin/css/zarin-adm-page-style.css">--%>
  <%--<link rel="stylesheet" type="text/css" href="app/modules/admin/css/zarin-shop-admin-page-style.css">--%>
  <%--<link rel="stylesheet" type="text/css" href="app/modules/admin/css/zarin-user-profile-style.css">--%>
...
<%--</head>--%>
  ...
  <%--<!-- Modals -->--%>
  <%--<!-- Sign in modal -->--%>
  <%--<div class="modal fade login_form" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" style="background-color: rgba(0, 0, 0, 0.78)   ">--%>
            ...
            <%--<form class="login-form" action="j_spring_security_check" method="post" >--%>
              <%--<fieldset>--%>
                  ...
                  <%--<p class="textColor">--%>
                      ...
                      <%--<input class="form-control ButtonColor BtnTextColor textColor" id="j_username" name="j_username" size="20" maxlength="50" type="text"/>--%>
                <%--</p>--%>

                  <%--<p class="textColor">--%>
                      <%--<label>Password</label>:--%>
                      <%--<input class="form-control ButtonColor BtnTextColor textColor" id="j_password" name="j_password" size="20" maxlength="50" type="password"/>--%>
                  <%--</p>--%>

                  <%--<!--<p><input type="submit" value="Login"/></p>-->--%>
               <%--<p>--%>
                 <%--<button type="button" class="btn ButtonColor BtnTextColor textColor" data-dismiss="modal">Close</button>--%>
                 <%--<button type="submit" class="btn ButtonColor BtnTextColor textColor" data-dismiss="modal">Login</button>--%>
               <%--</p>--%>
              <%--</fieldset>--%>
            <%--</form>--%>
              <%--<p align="center">If you haven't account, you can register now as <a data-toggle="modal" data-target=".registration_form_customer" data-dismiss="modal"> customer </a> or <a data-toggle="modal" data-target=".registration_form_shop" data-dismiss="modal"> shop </a></p>--%>
            <%--</div>--%>
          ...
          <%--<div class="tab-content">--%>
            ...
            <%--<div class="tab-pane shop" id="shop">--%>
              <%--<form class="form-horizontal">--%>
                ...
                <%--</div>--%>
                <%--<div class="form-group">--%>
                  <%--<label class="col-md-2 control-label">Reo. pass</label>--%>
                  <%--<div class="col-md-8">--%>
                    <%--<input type="text" class="form-control">--%>
                  <%--</div>--%>
                <%--</div>--%>
