...
<%--<head>--%>
    ...
    <%--<!--   <link rel="stylesheet" type="text/css" href="app/modules/home/css/anton-main-page-styles.css"> -->--%>
    <%--<link href="app/modules/goods/css/nazar-style-for_characteristic-of-product.css" rel="stylesheet" type="text/css" media="screen"/>--%>
    ...
    <%--<script type="text/javascript" src="app/modules/admin/controllers/LineChartCtrl.js"></script>--%>
    ...
    <%--&lt;%&ndash;<script src="https://ajax.googleapis.com/ajax/libs/prototype/1.7.2.0/prototype.js"></script>&ndash;%&gt;--%>
    <%--<script type="text/javascript" src="app/modules/admin/otherjs/templates.js"></script>--%>
    <%--&lt;%&ndash;<script src="http://code.highcharts.com/highcharts.js"></script>&ndash;%&gt;--%>
    <%--&lt;%&ndash;<script src="http://code.highcharts.com/app/modules/exporting.js"></script>&ndash;%&gt;--%>
